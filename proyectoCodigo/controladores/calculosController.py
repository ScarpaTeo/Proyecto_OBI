    ...
    def verCimiento(self):
        def calcular(dato):
            ...
            if dato!=False and dato!=True:
                ...
                cc=ci.vistaCimiento(string,"DISABLE")
                calcular(cc)
        ci=Cimiento()
    ...
    def verRevoque(self):
        def calcular(dato):
            ...
            if dato!=False and dato!=True:
                ...
                cc=ci.vistaRevoque(string,"disable")
                calcular(cc)
        ci=Revoque()
    ...
    def verContrapiso(self):
        def calcular(dato):
            ...
            if dato!=False and dato!=True:
                ...
                Piedra...${2}\n
                Total...${3}'''.format(round(total[0],2),round(total[1],2),round(total[2],2),round(sum(total),2))
                cc=ci.vistaContrapiso(string,"disable")
                calcular(cc)
        ci=Contrapiso()
    ...
    def verPared(self):
        def calcular(dato):
            ...
            if dato!=False and dato!=True:
                ...
                Ladrillos...${3}
                Total...${4}'''.format(round(total[0], 2), round(total[1], 2), round(total[2], 2), round(total[3], 2),round(sum(total), 2))
                cc=ci.vistaPared(string,"disable")
                calcular(cc)
        ci=Pared()
        dato=ci.vistaPared()
        calcular(dato)
    ...
    def verTecho(self):
        def calcular(dato):
            ...
            if dato!=False and dato!=True:
                ...
                cc=ci.vistaTecho(string,"disable")
                calcular(cc)
        ci=Techo()
        dato=ci.vistaTecho()
        calcular(dato)
