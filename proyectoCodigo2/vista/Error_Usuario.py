...
class Error_Usuario():
    ...
    def errorUsarioIncorrecto(self):
        ...
        Aceptar=Button(ventana, text="Aceptar", relief="flat",activebackground="#FFD42A",bg="#FFD42A", command=Obtener)
    ...
    def errorCamposVacios(self):
        ...
        msjError=Label(ventana, image=img).place(x=-2, y=-13)
        Aceptar=Button(ventana, text="Aceptar", relief="flat",bg="#FFD42A",activebackground="#FFD42A", command=Obtener)
        Aceptar.config(height=2, width=20)
        Aceptar.place(x=211, y=61)
        ventana.focus_force()
        ventana.mainloop()
