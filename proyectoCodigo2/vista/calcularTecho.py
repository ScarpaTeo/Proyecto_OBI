...
class Techo():
    ...
    def vistaTecho(self,resultado="",estado="normal"):
        ...
        if estado=="normal":
        #---------boton calcular
            BcalcularCimiento=Button(ventana,width=11,relief="flat",activebackground="#FFDE00",bg="#FFDE00",font=('Arial',19),text="Calcular",command=calcular).place(x=103,y=461)
            #--------------seguir calculando
