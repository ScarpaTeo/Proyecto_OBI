    ...
    def vistaCimiento(self,resultado="",estado="normal"):
        ...
        if estado =="normal":
            ...
            Bañadir=Button(ventana,state=DISABLED,width=8,relief="flat",activebackground="#FFDE00",bg="#FFDE00",font=('Arial',10),text="añadir",command=añadir).place(x=371,y=460)
             #-------------imprimir detalle
            Bimprimir=Button(ventana,state=DISABLED,width=8,relief="flat",activebackground="#FFDE00",bg="#FFDE00",font=('Arial',10),text="imprimir",command=imprimir).place(x=517,y=460)
        else:
            #--------------seguir calculando
            ...
            BcalcularCimiento=Button(ventana,state=DISABLED,width=12,relief="flat",activebackground="#FFDE00",bg="#FFDE00",font=('Arial',18),text="Calcular",command=calcular).place(x=97,y=450)
             ...
             #-------------imprimir detalle
            Bimprimir=Button(ventana,width=8,relief="flat",activebackground="#FFDE00",bg="#FFDE00",font=('Arial',10),text="imprimir",command=imprimir).place(x=517,y=460)
        # ---------boton atras
