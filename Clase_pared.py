...
class Pared_Bloques:
    ...
    def calculo_PC15(self):
        ...
        cadena="{0}Kg cal ,{1}Kg cementos ,{2}M3 arena ,{3} bloques".format(cal,cemento,arena,bloques)
...
class Pared_Comun:
    ...
    def calculo_PC15(self):
        ...
        cadena="{0}Kg cal ,{1}Kg cementos ,{2}M3 arena ,{3} ladrillos".format(cal,cemento,arena,bloques)
        print("objeto calculado")
        return cadena
    def calculo_PC20(self):
        'Calculo pared de tabique ceramico hueco de 20cm'
